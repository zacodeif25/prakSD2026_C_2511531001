...
public class InsertionGUI_2511531001 extends JFrame {
	 ...
	 * Create the frame.
	 */
	public InsertionGUI_2511531001() {
	...
	private void performStep_1001() {
		if (i_1001 < array_1001.length && sorting_1001) {
			int  key_1001 = array_1001 [i_1001];
			j_1001 = i_1001 - 1;
			
			StringBuilder stepLog_1001 = new StringBuilder();
			stepLog_1001.append("Langkah ").append(stepCount_1001).
			append (": Memasukkan ").append (key_1001).append("\n");
			
			while (j_1001 >= 0 && array_1001[j_1001] > key_1001) {
				array_1001 [j_1001 + 1] = array_1001 [j_1001];
				j_1001--;
			}
			array_1001 [ j_1001 + 1] = key_1001;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					InsertionGUI_2511531001 frame = new InsertionGUI_2511531001();
